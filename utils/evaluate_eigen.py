...
#parser.add_argument('--predicted_depth_path', type=str,   help='path to estimated depth',      required=True)
...
if __name__ == '__main__':
    ...
    pred_depths = np.load(args.predicted_disp_path)
    ...
    if args.split == 'kitti':
        ...
        num_samples = 584
        test_files = read_text_lines(args.gt_path + 'new_test_files.txt')
