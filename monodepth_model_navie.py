...
class MonodepthModel(object):
    ...
    def build_outputs(self):
        ...
        with tf.variable_scope('disparities'):
            ...
            self.disp_right_est  = [tf.expand_dims(d[:,:,:,0], 3) for d in self.disp_est]
        ...
        with tf.variable_scope('smoothness'):
            #self.disp_left_smoothness  = self.get_disparity_smoothness(self.disp_right_est,  self.right_pyramid)
    ...
    def build_losses(self):
        with tf.variable_scope('losses', reuse=self.reuse_variables):
            ...
            self.disp_gradient_loss = tf.add_n(self.disp_right_loss)
